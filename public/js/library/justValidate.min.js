var __defProp = Object.defineProperty,
   ...
   __defNormalProp = (e, i, s) =>
      i in e ? __defProp(e, i, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (e[i] = s),
   __spreadValues = (e, i) => {
...
!(function (e, i) {
   'object' == typeof exports && 'undefined' != typeof module
      ...
      ? define(i)
      : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).JustValidate = i());
})(this, function () {
   'use strict';
   const e =
   ...
   return class {
      ...
      getFieldErrorMessage(e, i) {
         const s =
            'function' == typeof e.errorMessage ? e.errorMessage(this.getElemValue(i), this.fields) : e.errorMessage;
         return (
                  ...
                  const i = (e, i) => {
                     const s = Number.isFinite(i.minSize) && e.size < i.minSize,
                        ...
                        r =
                           ...
                           !i.extensions.includes(e.name.split('.')[e.name.split('.').length - 1]),
         ...
         return (
            i.forEach((i) => {
               ...
               if (!(i.validator || i.plugin || (i.rule && Object.values(l).includes(i.rule))))
                  throw Error(
                     `Rule should be one of these types: ${Object.values(l).join(', ')}. Provided value: ${i.rule}`,
                  );
            }),
      ...
      clearFieldStyle(e) {
         ...
         Object.keys(a).forEach((e) => {
            ...
            r.elem.classList.remove(
               ...n((null == (t = r.config) ? void 0 : t.errorFieldCssClass) || this.globalConfig.errorFieldCssClass),
               ...n(
      ...
      clearErrors() {
         ...
         for (const s in this.groupFields) {
            ...
            const r =
               (null == (i = t.config) ? void 0 : i.successFieldStyle) || this.globalConfig.successFieldStyle || {};
      ...
      createErrorLabelElem(e, i, s) {
         ...
         return (
            ...
            t.classList.add(
               ...n((null == s ? void 0 : s.errorLabelCssClass) || this.globalConfig.errorLabelCssClass),
      ...
      createSuccessLabelElem(e, i, s) {
         ...
         return (
            Object.assign(t.style, l),
            t.classList.add(
               ...n((null == s ? void 0 : s.successLabelCssClass) || this.globalConfig.successLabelCssClass),
      ...
      renderFieldError(e, i) {
         ...
         (this.isValid = !1),
            d.elem.classList.add(
               ...n((null == (l = d.config) ? void 0 : l.errorFieldCssClass) || this.globalConfig.errorFieldCssClass),
            );
            ...
            this.isTooltip() &&
               this.tooltips.push(
                  this.renderTooltip(
                     d.elem,
                     u,
                     null == (a = null == (o = d.config) ? void 0 : o.tooltip) ? void 0 : a.position,
                  ),
               );
      }
      renderErrors(e = !1) {
            ...
            for (const e in this.groupFields) {
               ...
               (this.isValid = !1),
                  r.elems.forEach((e) => {
                     ...
                     Object.assign(
                        e.style,
                        (null == (i = r.config) ? void 0 : i.errorFieldStyle) || this.globalConfig.errorFieldStyle,
                     ),
                        e.classList.add(
                           ...n(
                  ...
                  this.isTooltip() &&
                     this.tooltips.push(
                        this.renderTooltip(
                           r.groupElem,
                           o,
                           null == (l = null == (t = r.config) ? void 0 : t.tooltip) ? void 0 : l.position,
                        ),
                     );
            }
